...
(function () {
  ...
  function animate() {
    ...
    cards.forEach((card) => {
      ...
      // ⚡ Bolt: Use squared distance check to skip expensive Math.sqrt when outside influence radius
      ...
      const influence = distSq < CONFIG.influenceRadiusSq
          ? Math.max(0, 1 - Math.sqrt(distSq) / CONFIG.influenceRadius)
          : 0;
