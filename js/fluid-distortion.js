...
(function () {
  ...
  function animate() {
    ...
    cards.forEach((card) => {
      ...
      // Only compute expensive Math.sqrt for cards inside the influence radius.
      // We still need the exact distance to maintain the smooth continuous ripple gradient.
      let influence = 0;
