...
(function () {
  ...
  CONFIG.influenceRadiusSq = CONFIG.influenceRadius * CONFIG.influenceRadius; // Pre-calculated squared radius for perf
  ...
  function animate() {
    ...
    cards.forEach((card) => {
      ...
      if (isOverCard || distSq < CONFIG.influenceRadiusSq) {
        // Only calculate exact Math.sqrt if within influence radius or hovered
