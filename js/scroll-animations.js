  ...
  function initMagneticLinks() {
    ...
    document.querySelectorAll('.social-link, .project-link, .form-submit').forEach(el => {
      ...
      el.addEventListener('mouseenter', () => {
        // Cache rect and scroll position on enter to avoid layout thrashing and inaccurate displaced coordinates
      ...
      el.addEventListener('mousemove', (e) => {
        ...
        // Adjust cached coordinates using scroll differences
